...
TEXT = {
    "en": {
        ...
        "custom_saliency": "Saliency (0=off, fork only)",
        "optimize_json": "Optimize",
        "output_dir": "Output folder",
        "browse": "Browse...",
        "flat_mode": "Flat / Poster mode (flat art)",
        "hybrid_mode": "Hybrid (flat base + detail)",
        "gen_mode": "Mode",
        "mode_geometrize": "Geometrize (GPU)",
        "mode_flat": "Flat",
        "mode_superpixel": "Superpixel",
        "mode_refine": "Refine (CPU)",
        "mode_ultra": "Ultra (CPU)",
        "mode_ultra_diff": "Ultra+Diff (GPU)",
        "mode_hybrid": "Hybrid",
        "flat_colors": "Colors",
        "flat_segments": "Segments",
        "hybrid_detail": "Detail",
        "refine_shapes": "Shapes",
        "ultra_shapes": "Ultra shapes",
        "r5_iters": "R5 iters",
        "r5_res": "R5 res",
        "r5_grad": "R5 gradient",
        "r5_edges": "R5 edges",
        ...
        "no_preview": "No preview to download yet. Select an image or generated JSON first.",
        "saved_preview_to": "Saved preview to {path}",
        "mode_geometrize_note": "Geometrize uses the GPU generator and the quality preset below (Step 2).",
